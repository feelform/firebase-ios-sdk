 ...
 * test case. This makes it possible to easily run those benchmarks are an
 * iPhone directly from within Xcode.
 */
...
- (void)testRunBenchmarks {
  char* argv[] = {
      strdup("FSTBenchmarkTests"),
      strdup("--benchmark_filter=BM_.*"),
  };
